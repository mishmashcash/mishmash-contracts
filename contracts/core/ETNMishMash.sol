...
contract ETNMishMash is MishMash {
  constructor(
    IVerifier _verifier,
    IHasher _hasher,
  ...
  function _processWithdraw(
    ...
    // sanity checks
    require(msg.value == 0, "Message value is supposed to be zero for ETN instance");
    require(_refund == 0, "Refund value is supposed to be zero for ETN instance");
