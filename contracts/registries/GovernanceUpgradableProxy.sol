...
/**
 * @dev TransparentUpgradeableProxy where governance is allowed to call implementation methods.
 */
contract GovernanceUpgradeableProxy is TransparentUpgradeableProxy {
  /**
  ...
  constructor(
    ...
    address _governance,
    bytes memory _data
  ) public payable TransparentUpgradeableProxy(_logic, _governance, _data) {}

  /**
   * @dev Override to allow governance access the fallback function.
   */
