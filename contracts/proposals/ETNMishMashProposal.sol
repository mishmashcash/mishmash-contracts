...
contract ETNMishMashProposal {
    ...
    constructor(IVerifier _verifier, IHasher _hasher, uint _denomination) {
        verifier = _verifier;
        hasher = _hasher;
    ...
    function executeProposal() external {
        ...
        ETNMishMash etnInstance = new ETNMishMash(verifier, hasher, denomination, merkleTreeHeight);
